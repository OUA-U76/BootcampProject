...
{
    const string privateCode = "4OxIovuix0mEs5on-1neogcBWVV3S6AUiVFl-TBI5itg";  //Key to Upload New Info
    const string publicCode = "64b2b9478f40bb67c42524ec";   //Key to download
